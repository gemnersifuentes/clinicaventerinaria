<footer class="w-full bg-gray-900 border-t border-gray-200">
    <div class="mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-4 lg:gap-8 py-14 max-w-xs mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-full">
            <!-- Logo y descripción -->
            <div class="col-span-full lg:col-span-2 mb-10 lg:mb-0">
                ...
                <p class="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">
                    Cuida de tu mascota con dedicación y cariño. Ofrecemos servicios médicos y estéticos con atención personalizada, asegurando el bienestar y felicidad de tu mejor amigo.
                </p>
                <!-- Redes sociales -->
                <div class="flex mt-4 space-x-4 justify-center lg:justify-start">
                    <a href="javascript:;" class="w-9 h-9 rounded-full bg-indigo-600 flex justify-center items-center hover:bg-indigo-600">
            ...
            <div class="text-center lg:text-left">
                <h3 class="text-sm font-semibold text-gray-400 uppercase tracking-wider">Enlaces</h3>
            ...
            <!-- Contacto -->
            <div class="text-center lg:text-left">
                <h3 class="text-sm font-semibold text-gray-400 uppercase tracking-wider">Contacto</h3>
                <ul class="mt-4 space-y-2">
                    <li class="text-gray-300">Tel: +51 123 456 789</li>
                    <li class="text-gray-300">Email: contacto@scoobydoo.com</li>
                    <li class="text-gray-300">Dirección: Av. Siempre Viva 123</li>
                </ul>
            </div>

            <!-- Suscripción -->
            <div class="col-span-full lg:col-span-2">
                <h3 class="text-sm font-semibold text-gray-400 uppercase tracking-wider text-center lg:text-left">Suscríbete</h3>
                <form class="mt-4 flex items-center justify-center lg:justify-start">
                    <input type="email" placeholder="Ingresa tu correo" class="px-4 py-2 rounded-l-md bg-gray-800 text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-600">
                    <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-r-md hover:bg-indigo-700">Suscribirse</button>
                </form>
            </div>
        </div>
    </div>
